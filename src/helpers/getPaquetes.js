...
export const getPaquetes = async (idiomaId)=> {
    const url = 'http://destinopatagonia.elemsoft.net/webapi/api/Excursiones/GetListPaquetes'
...
export const getPaquetesById = async (idiomaId,paqueteId)=>{
    const url = 'http://destinopatagonia.elemsoft.net/webapi/api/Excursiones/GetPaqueteDetalles'
...
export const getTarifasPaquete = async (idiomaId,paqueteId,fecha)=>{
    const url = 'http://destinopatagonia.elemsoft.net/webapi/api/Reservas/GetListHorariosTarifasDisponiblesPaquetes'
