  ...
  return (
    <div>
      ...
      <div className="containerNos">
        <h2 style={{ fontSize: "3rem" }}>DESTINO PATAGONIA</h2>
        ...
        <div className="containerNos_vision container-xl">
          ...
          <p>
            ...
            reconocida y recomendada para que nuestros clientes sientan la total
            confianza a la hora de elegirnos. Nuestra misión es ser una empresa
            de navegación elegida nacional e internacionalmente, por la calidad
            de sus servicios.{" "}
          </p>
        </div>
